...
storiesOf("dev-shopping-page/molecules", module)
  ...
  .add("search-form-user/loading", () => (
    <SearchFormUser getDeveloper={action("get-dev")} loading={true} />
  ))
  .add("search-form-user/not-loading", () => (
    <SearchFormUser getDeveloper={action("get-dev")} loading={false} />
  ));
...
storiesOf("dev-shopping-page/organisms", module)
  .add("dev-list", () => <DevList context={mockedContext} />)
